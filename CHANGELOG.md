...
- Forecasts no longer learn manually recorded USD or yearly recurring payments as variable spending before projecting the same rules again, and Dashboard balance history no longer plots unsupported points from before the first balance snapshot.
