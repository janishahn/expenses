...
from expenses_web.ai.client import (
    LLMDisabledError,
    LLMRunner,
    LLMRunResult,
    PydanticAILLMRunner,
...
from expenses_web.services.main import (
    CategoryService,
    RuleService,
    TransactionService,
    parse_advanced_search,
)
from expenses_web.schemas import RuleIn, TransactionIn


logger = get_logger("expenses_web.ai")
...
class LLMAssistantService:
    ...
    def _existing_rule_payload(self) -> list[dict[str, Any]]:
        from expenses_web.db.models import Rule
