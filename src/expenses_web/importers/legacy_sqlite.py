...
from expenses_web.recurrence.engine import calculate_next_date
from expenses_web.services import rebuild_monthly_rollups, get_current_user_id
        ...
        *,
        ...
        try:
            ...
            for r in cur.fetchall():
                ...
                if preserve_time_in_title and dt.time() != datetime.min.time():
                    title = f"{title} (time {dt.strftime('%H:%M:%S')})"
                    time_appended += 1
                ...
                if (
                    ...
                    and title.endswith(" (Recurring)")
                ):
                    base = title[: -len(" (Recurring)")]
            ...
            return {
                ...
                "time_appended_to_titles": time_appended,
