...
from expenses_web.infra.fx_rates import FxRateService
from expenses_web.services.rollups import recompute_monthly_rollup_for_date
...
class RecurrenceRuleLike(Protocol):
...
def calculate_next_date(rule: RecurrenceRuleLike, from_date: date) -> date:
