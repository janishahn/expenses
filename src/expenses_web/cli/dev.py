...
from expenses_web.cli.migrations import upgrade_head
from expenses_web.cli.mock_db import db_is_empty, db_path_from_url
...
def _preflight_db() -> bool:
    ...
    from expenses_web.cli.mock_db import seed
