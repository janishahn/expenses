...
from expenses.recurrence.scheduling import SchedulerManager
...
app_logger = get_logger("expenses.app")
...
def main() -> None:
    ...
    uvicorn.run("expenses.app:app", host="0.0.0.0", port=8000, reload=False)
