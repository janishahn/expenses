...
class LLMJob(Base):
    ...
    usage_total_tokens: Mapped[Optional[int]] = mapped_column(Integer)
    usage_cached_input_tokens: Mapped[Optional[int]] = mapped_column(Integer)
    usage_cache_write_tokens: Mapped[Optional[int]] = mapped_column(Integer)
    usage_reasoning_tokens: Mapped[Optional[int]] = mapped_column(Integer)
    usage_request_count: Mapped[Optional[int]] = mapped_column(Integer)
    usage_tool_call_count: Mapped[Optional[int]] = mapped_column(Integer)
    usage_cost_decimal: Mapped[Optional[str]] = mapped_column(String(80))
    usage_cost_unit: Mapped[Optional[str]] = mapped_column(String(40))
    llm_provider: Mapped[Optional[str]] = mapped_column(String(40))
    provider_name: Mapped[Optional[str]] = mapped_column(String(80))
    provider_model: Mapped[Optional[str]] = mapped_column(String(120))
    provider_response_id: Mapped[Optional[str]] = mapped_column(String(160))
    provider_request_id: Mapped[Optional[str]] = mapped_column(String(160))
